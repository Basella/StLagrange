...
export class SizeGuide {
  ...
  private sizeGDescription: string;
  ...
  public get SizeGDescription(): string {
    return this.sizeGDescription;
  }
  public set SizeGDescription(value: string) {
    this.sizeGDescription = value;
    if (this.objectState === ObjectState.Unchanged) {
      this.objectState = ObjectState.Changed;
    }
  }
