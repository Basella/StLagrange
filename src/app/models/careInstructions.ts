...
export class CareInstructions {
  ...
  public get CareIDescription(): any[] {
    return this.careIDescription;
  }
  public set CareIDescription(value: any[]) {
    this.careIDescription = value;
    if (this.objectState === ObjectState.Unchanged) {
      this.objectState = ObjectState.Changed;
    }
  }
